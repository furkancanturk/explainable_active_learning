...
def main(
        ...
        model_params = {'C':0.1, 'n_jobs':-1, 'max_iter':1000}
        ):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-strategy_name', type=str, default='Uncertainty', \
                        choices=['ClusteredUncertainty', 'Uncertainty', 'MostUncertainCluster', 'UncertaintyClustered', "Random"])
    
    parser.add_argument('-user_name', type=str, default='user1', \
                        choices=  ['user1', 'user2', 'user3',  'sportive_user1', 'unhealthy_user1', 'vegan_user2', 'elder_user2', 'sportive_user3', 'unhealthy_user3', 'random'])
    ...
    main(user_name = args.user_name, strategy_name = args.strategy_name, dataset_code=args.dataset_code, random_state = args.random_state)
